...
const StorePurchaseInfoview = ({ storePurchaseData }) => {
      ...
      <div className="mt-3 card LineSpace ">
        <div className="bg-danger card-header notification border-x-0 border-bottom-0 border-300 rounded-0">
          <div className="d-flex justify-content-between ">
            <h5 className="text-white">Store Purchase Details</h5>
          </div>
        </div>
        ...
        <div className="fs--1 card-body">
          <div className="row">
            <div className="h-100 col-md-4">
              <h6 className="fs-0 mb-0">Store Purchase Created Date </h6>
            ...
            <div className="h-100 col-md-4">
              ...
              <label title="Fname">
                {get(storePurchaseData, 'invoiceNo', '')}
              </label>
            </div>
            <div className="h-100 col-md-4">
              <h6 className="fs-0 mb-0">Vendor Name</h6>
              <label title="Fname">
                {get(storePurchaseData, 'vendorName', '')}
              </label>
            </div>
          </div>
          <div className="row">
            <div className="h-100 col-md-4">
              ...
              <label title="Fname">
                {get(storePurchaseData, 'vendorCode', '')}
              </label>
            </div>
            <div className="h-100 col-md-4">
              <h6 className="fs-0 mb-0">Total Amount </h6>
              <label title="Fname">
                {get(storePurchaseData, 'totalAmount', '')}
              </label>
            </div>
            <div className="h-100 col-md-4">
              <h6 className="fs-0 mb-0">Grant Total</h6>
              <label title="Fname">
                {get(storePurchaseData, 'grantTotal', '')}
              </label>
            </div>
          </div>
        </div>
...
export default StorePurchaseInfoview;
