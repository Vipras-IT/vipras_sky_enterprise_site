...
const columns = [
  ...
  },
  {
    ...
    Header: 'Document',
    Cell: (rowData) => {
      const value = get(rowData, 'row.values.document', []);
      return value && value.length > 0 ? (
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src={value[0]} alt="Document" width="50" height="50" />
          <a href={value[0]} download target="_blank" rel="noopener noreferrer">
            <button
...
function ResumeList() {
  ...
  const { isLoading, error, data, isSuccess } = useQuery(
    ...
    () => resume.fetchResume(queryPageIndex, queryPageSize, queryPageFilter),
    {
          ...
          <Card>
            <Card.Header className="bg-shape modal-shape-header px-4 position-relative">
              <div className="position-relative z-index-1 light">
                <h5 className="mb-0 text-white">All Resume</h5>
              </div>
            </Card.Header>
            <Card.Header>
              <ResumeHeader
            ...
            <Card.Footer>
              <div className="pagination">
                ...
                <div>
                  ...
                  >
                    {[500, 1000, 1500, 'All'].map((pageSize) => (
                      <option
                        key={pageSize}
