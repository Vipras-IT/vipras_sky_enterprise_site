...
import EmployeeVerificationheader from 'components/EmployeeView/EmployeeVerificationheader';
...
const EmployeeVerificationView = () => {
  const { user } = useAuth();
  const getEmployeeAPI = useAPI(employeeAPI.getEmployeeDetails);
  const addRemoveEmployeeAPI = useAPI(employeeAPI.VerifiedEmployee);
...
export default EmployeeVerificationView;
