...
import { fetchEmployeeVerificationData } from 'api/getEmployeeData';
      ...
      return (
        <CardDropdown iconClassName="fs--1" drop="start">
          <div className="py-2">
            <Dropdown.Item
              as={Link}
              to={`/employee-verification/${get(rowData, 'row.values.id', '')}`}
          ...
          <Card>
            <Card.Header className="bg-shape modal-shape-header px-4 position-relative">
              <div className="position-relative z-index-1 light">
                <h5 className="mb-0 text-white">Pending Verification Report</h5>
              </div>
            </Card.Header>
            <Card.Header>
              <EmployeesHeader
            ...
            <Card.Footer>
              <div className="pagination">
                ...
                <div>
                  ...
                  >
                    {[100, 200, 500, 1000, 2000].map((pageSize) => (
