...
const EmployeesHeader = ({
  ...
  const [searchType, setSearchType] = React.useState('Employee Id');
  ...
  return (
    <Row className="flex-between-center">
      <Col xs={4} sm="auto" className="d-flex align-items-center pe-0">
        <h4 className="fs-0 mb-0 text-nowrap py-2 py-xl-0">Addlist</h4>
      </Col>
      <Col xs={4} sm="auto" className="d-flex flex-between-center">
        ...
        >
          {['Employee Role', 'User Id', 'Employee Id', 'Site Id'].map(
            (pageSize) => (
