...
const EmployeesHeader = ({ onClickFilterCallback, defaultKeyword }) => {
  const [keyword, setKeyword] = React.useState(defaultKeyword);
  const [searchType, setSearchType] = React.useState('employeeName');
  ...
  return (
    <Row className="flex-between-center">
      ...
      <Col xs={4} sm="auto" className="d-flex flex-between-center">
        ...
        >
          {['employeeIDNumber', 'employeeName', 'designation'].map(
            (pageSize) => (
