...
const InternalHeader = ({
  ...
  const searchTypeMapping = {
    'Ticket Alloted To': 'assignedEmployeeName',
    'Escalation 1': 'firstLevelEmployeeName',
    'Escalation 2': 'secondLevelEmployeeName',
    'Ticket Type': 'ticketType',
    'Ticket Status': 'status',
    'Ticket Priority': 'ticketPriority',
  };
  const [searchType, setSearchType] = React.useState('vendorName');
  ...
  return (
    <Row className="flex-between-center">
      <Col xs={4} sm="auto" className="d-flex align-items-center pe-0">
        <h4 className="fs-0 mb-0 text-nowrap py-2 py-xl-0">Internal Tickets</h4>
      </Col>
