...
const HouseKeepingComparison = () => {
  ...
  const onClickExportAsExcel = () => {
    ...
    saveAs(blob, 'House Keeping-Profit-Loss-Report.xlsx');
  };

  const getSiteSalaryDetails = (month, year) => {
    const departmentServices = 'House Keeping Services';
    invoiceApi
      ...
      <Card>
        <Card.Header className="bg-shape modal-shape-header px-20 position-relative">
          <div className="position-relative light">
            <h5 className="mb-0 text-white"> House Keeping</h5>
          </div>
        </Card.Header>
        <br />
...
export default HouseKeepingComparison;
