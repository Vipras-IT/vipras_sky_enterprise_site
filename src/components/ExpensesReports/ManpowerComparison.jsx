...
const ManpowerComparison = () => {
  ...
  const onClickExportAsExcel = () => {
    ...
    saveAs(blob, 'Manpower Services-Profit-Loss-Report.xlsx');
  };

  const getSiteSalaryDetails = (month, year, token) => {
    const departmentServices = 'Manpower Services';
    invoiceApi
      ...
      <Card>
        <Card.Header className="bg-shape modal-shape-header px-20 position-relative">
          <div className="position-relative light">
            <h5 className="mb-0 text-white"> Manpower Services</h5>
          </div>
        </Card.Header>
        <br />
...
export default ManpowerComparison;
